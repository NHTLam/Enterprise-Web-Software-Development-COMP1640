...
function ManageTopic() {
  ...
  return (
    <div className="container">
        ...
        <tbody>
          <tr>
            ...
            <td className="topic_tile">
              <div className="d-flex align-items-center">IT</div>
            </td>
            <td className="topic_startdate">22/22/2022</td>
            <td className="topic_enddate">24/22/2022</td>
            <td className="topic_description">description</td>
      ...
      <div className="btn btn-success m-2">Add new request Topic</div>
