...
namespace CodeBE_COMP1640.Controllers.PermissionController
{
    public class PermissionController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<Role>>> ListRole()
        {
        ...
        public async Task<ActionResult<Role>> Get([FromBody] Role Role)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
        ...
        public async Task<ActionResult<bool>> CreateRole([FromBody] Role Role)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
        ...
        public async Task<ActionResult<Role>> Delete([FromBody] Role Role)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
